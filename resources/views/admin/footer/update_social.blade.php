...
@section('title', 'تعديل وسائل التواصل الاجتماعي لزمزم ')
@section('content')
    <div class="col-12">
        ...
        <form action="{{ route('footer.update_social_check', $footerContact->id) }}" class="form" method="POST"
            ...
            <div class="form-row mb-3 pl-2">
                <div class="col-12">
                    ...
                    <input type="file" name="image" class="form-control" value="{{ $footerContact->image }}"
